...
from EarlyBird_modified_v2 import EarlyBird
    ...
    def _train_client(
        ...
        for epoch in range(self.args.n_client_epochs):
            ...
            if pre_eb and eb_client.early_bird_emerge(model): #eb_client = class instance
                ...
                """
                client_mask = eb_client.get_mask_for_hooks(model, 0.3) #get dict of mask
        ...
        eb_client.pruning_by_mask(model, client_mask)
        
        self.count_zero_weights(model, s = "Counting zero channels")
